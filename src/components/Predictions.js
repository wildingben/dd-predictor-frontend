  ...
  return (
    <div className="card" style={{ marginBottom: '12px' }}>
      <div onClick={() => setExpanded(e => !e)} style={{ cursor: 'pointer' }}>
        <div style={S.matchDate}>{formatDate(fixture.match_date)} {fixture.match_time ? `· ${fixture.match_time} UTC` : ''}</div>
  ...
  return (
    <div>
      <div className="fade-up">
        ...
        <p className="page-sub">Enter any gameweek — past or upcoming</p>
      </div>
      ...
      {!data && !loading && !error && (
        <div style={{ textAlign: 'center', padding: '60px 20px', color: 'var(--text3)' }}>
          ...
          <p style={{ fontSize: '15px' }}>Enter a gameweek number above</p>
        </div>
      )}
    </div>
  );
